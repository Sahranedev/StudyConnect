      ...
      <div className="w-full flex justify-center">
        <div className="w-[21rem] h-64 rounded-b-lg relative"> 
          ...
          <FaClock color="white" className="ml-1" />
            <p className="text-white ml-2 text-sm">{course.formattedStartTime}-{course.formattedEndTime}</p>
          </div>
          <div className="bg-darkGrey rounded-t-lg rounded-b-lg absolute bottom-[10px] w-full "> 
            <CardTitle className="text-white pt-2 pl-2 text-[20px]">{course.name}</CardTitle>
            <div className="flex justify-around items-center">

            <CardDescription className="text-white text-[12px] wrap p-2">
              {course.description}
              </CardDescription>
              <FaPlayCircle color={"white"} size={40} className="mr-6"/>
            </div>
          </div>
        </div>
      </div>
